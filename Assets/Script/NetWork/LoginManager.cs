...
public class LoginManager : MonoBehaviour
{
    ...
    {       
        ...
        {
            Singletone_PlayerManager.Singletone_Information.OpenWnd(0,0, "비밀번호 확인이 일치하지 않습니다");
        }
        ...
        else if (NewAccount_PW.text == NewAccount_PW_RE.text)
        {
            ...
            {
                Singletone_PlayerManager.Singletone_Information.OpenWnd(0,0, "0으로 시작하는 비밀번호는 사용 할 수 없습니다");
                NewAccount_PW.text = "";
                NewAccount_PW_RE.text = "";
                return;
            }
            Singletone_NetWorkManager.Singletone_Information.Send_Account_Create_New(NewAccount_ID.text, NewAccount_PW.text);
            NewAccount_ID.text = "";
            NewAccount_PW.text = "";
            NewAccount_PW_RE.text = "";
        }
    ...
    {
        //exception
        Singletone_NetWorkManager.Singletone_Information.Send_Account_Login(Login_ID.text, Login_PW.text);
